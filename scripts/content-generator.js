...
2. 국내 공식 기관 데이터 최소 2회 인용
   예시: "국민체육진흥공단에 따르면...", "국민건강영양조사 결과...", "대한스포츠의학회 권고에 따르면..."
3. 첫 문단은 반드시 실생활 사례로 시작
   예시: "3년째 다이어트에 번번이 실패한 38세 직장인 이모씨는 최근..."
4. 글 구조는 매번 달라야 합니다. 이번엔 "${structureType}" 유형으로 작성하세요.
5. 문단마다 3~5문장. 짧은 두 줄로 끝내지 말 것.
6. ⚠️ 뻔한 상식(운동하세요, 균형 잡힌 식단, 꾸준히 하세요 등)은 절대 쓰지 말 것
7. 전문적인 근거와 메커니즘 설명 포함 (왜 그런지 원리까지)
8. 결론부에 "이 정보는 일반적인 운동·건강 정보 목적이며, 개인 체력 수준과 건강 상태에 따라 차이가 있습니다. 기저질환이 있거나 부상 위험이 있는 경우 반드시 전문가와 상담하시기 바랍니다." 포함
9. 글 전체에서 반드시 3가지 달성:
