...
const HEALTH_SUBTOPICS = [
  ...
  { id: 'health',       label: '생활건강',        guide: '수면과 다이어트, 스트레스와 체중 관리, 면역력 높이는 습관, 피로 회복, 건강검진, 만성피로, 소화 건강, 생활습관병 예방 등' },
  { id: 'skincare',     label: '스킨케어',        guide: '운동 후 피부 관리, 땀과 여드름 예방, 자외선 차단 스포츠 선크림, 다이어트 후 피부 처짐, 건강한 피부 식단, 피부 보습 루틴 등' },
  { id: 'beauty',       label: '뷰티·메이크업',   guide: '운동 메이크업, 헬스장 가기 전 피부 관리, 다이어트 후 체형 보완 코디, 건강미 메이크업, 운동하는 여성 뷰티 루틴 등' },
];
